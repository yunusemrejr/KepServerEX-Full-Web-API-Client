        ...
        function checkConnection() {
            ...
            iotGatewayRequest.open('GET', 'http://' + iotGateway + '/iotgateway/');
            ...
            normalApiRequest.open('GET', 'http://' + normalApi + '/config/v1/status');
        ...
        document.getElementById('checkbtn').addEventListener("click", () => {
            // Load tags and values from the API
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    let tagID;
                    // Set the value of the selected tag
                    ...
                    if (selectedTag) {
                        ...
                        dropdownOfTags.addEventListener("change", () => {
                            ...
                            fetch("http://" + document.getElementById("iot-gateway").value + "/iotgateway/read?ids=" + selectedTag)
                                .then(response => response.json())
                                .then(data => {
                    ...
                    setInterval(() => {
                        ...
                        data.browseResults.forEach(tag => {
                            fetch("http://" + document.getElementById("iot-gateway").value + "/iotgateway/read?ids=" + tag.id)
                                .then(response => response.json())
                                .then(data => {
                                    const selectedTagValue = data.readResults[0].v;
